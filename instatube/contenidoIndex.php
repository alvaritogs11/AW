					...
					<div id = "elemento" > 
						...
						<div id = "informacion">
							...
							<div id = "inferior">
								...
								<div  id = "tags"> 
									<input id = "tag" type = "button" value = "risa" ></input>
									<input id = "tag"  type = "button" value = "contagiosa" ></input>
									<input id = "tag" type = "button" value = "muchos videos" ></input>
								</div>	
							</div>
						</div>
					</div>		
					...
					<div id = "elemento" > 
						...
						<div id = "informacion">
							...
							<div id = "inferior">
								...
								<div  id = "tags"> 
									<input id = "tag" type = "button" value = "Joaquin Reyes" ></input>
									<input id = "tag"  type = "button" value = "Pablo Iglesias" ></input>
									<input id = "tag" type = "button" value = "Imitación" ></input>
									<input id = "tag" type = "button" value = "Podemos" ></input>					
								</div>	
							</div>
						</div>
					</div>		
